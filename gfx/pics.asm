...
BlueSagePic:      INCBIN "gfx/trainers/blue_sage.2bpp.lz"
YellowSagePic:    INCBIN "gfx/trainers/yellow_sage.2bpp.lz"
RedSagePic:    	INCBIN "gfx/trainers/red_sage.2bpp.lz"
GrandSagePic:      INCBIN "gfx/trainers/grand_sage.2bpp.lz"
