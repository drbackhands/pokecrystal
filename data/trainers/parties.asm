...
BlueSageGroup:
	; BLUE_SAGE (1)
	db "SAGE@", TRAINERTYPE_MOVES
	db 80, ARTICUNO, NEVERMELTICE, REST, SLEEP_TALK, ICE_BEAM, REFLECT
	db 75, SUICUNE, MYSTIC_WATER, SURF, TOXIC, ICE_BEAM, ROAR
	db 68, VAPOREON, LEFTOVERS, HYDRO_PUMP, GROWTH, REST, ACID_ARMOR
	db 70, GYARADOS, MYSTIC_WATER, HYDRO_PUMP, THUNDER, DOUBLE_EDGE, BLIZZARD
	db 73, BLASTOISE, LEFTOVERS, SURF, REST, SLEEP_TALK, ROAR
	db 72, FERALIGATR, LEFTOVERS, HYDRO_PUMP, EARTHQUAKE, ROCK_SLIDE, ANCIENTPOWER
	db -1 ; end

YellowSageGroup:
	; YELLOW_SAGE (1)
	db "SAGE@", TRAINERTYPE_MOVES
	db 5, ZAPDOS,      THUNDER, DRILL_PECK, THUNDER_WAVE, RAIN_DANCE
	db 5, RAIKOU,      CRUNCH, IRON_TAIL, THUNDERBOLT, THUNDER_WAVE
	db 5, JOLTEON,     ZAP_CANNON, SHADOW_BALL, PIN_MISSILE, GROWTH
	db 5, AMPHAROS,    IRON_TAIL, THUNDER, TOXIC, REST
	db 5, RAICHU,      SURF, THUNDER, RAIN_DANCE, SEISMIC_TOSS
	db 5, ELECTABUZZ,  THUNDER, PSYCHIC_M, ICE_PUNCH, PURSUIT
	db -1 ; end
...
RedSageGroup:
	; RED_SAGE (1)
	db "SAGE@", TRAINERTYPE_MOVES
	db 80, MOLTRES, CHARCOAL, SUNNY_DAY, FIRE_BLAST, REST, SLEEP_TALK
	db 75, ENTEI, CHARCOAL, SUNNY_DAY, FIRE_BLAST, SOLARBEAM, TOXIC
	db 68, FLAREON, LEFTOVERS, GROWTH, FIRE_BLAST, DOUBLE_EDGE, BATON_PASS
	db 70, ARCANINE, FIRE_BLAST, BODY_SLAM, CRUNCH, EXTREMESPEED
	db 73, CHARIZARD, LEFTOVERS, SURF, THUNDER, RAIN_DANCE, SEISMIC_TOSS
	db 72, TYPHLOSION, LEFTOVERS, BELLY_DRUM, EARTHQUAKE, ROCK_SLIDE, FIRE_BLAST
	db -1 ; end

GrandSageGroup:
	; GRAND_SAGE (1)
	db "SAGE@", TRAINERTYPE_MOVES
	db 81, ARTICUNO, NEVERMELTICE, REST, SLEEP_TALK, ICE_BEAM, REFLECT
	db 82, ZAPDOS, MAGNET, THUNDER, DRILL_PECK, THUNDER_WAVE, RAIN_DANCE
	db 81, MOLTRES, CHARCOAL, SUNNY_DAY, FIRE_BLAST, REST, SLEEP_TALK
	db 75, ESPEON, LEFTOVERS, GROWTH, PSYCHIC_M, MORNING_SUN, BATON_PASS
	db 75, UMBREON, LEFTOVERS, CHARM, PURSUIT, MOONLIGHT, CONFUSE_RAY
	db 89, CELEBI, LEFTOVERS, HEAL_BELL, RECOVER, LEECH_SEED, PSYCHIC_M
	db -1 ; end
