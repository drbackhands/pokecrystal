...
MapGroup_Dungeons:
	...
	map SeafoamCave, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_POND
	map RockTunnelCave, TILESET_FACILITY, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_POKEMON_MANSION, TRUE, PALETTE_NITE, FISHGROUP_POND
	map FieryCave, TILESET_ELITE_FOUR_ROOM, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_INDIGO_PLATEAU_RBY, FALSE, PALETTE_DAY, FISHGROUP_POND
