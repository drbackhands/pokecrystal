...
; New to Crystal
	...
	const EVENT_SHINY_ZUBAT
	const EVENT_SHINY_DUNSPARCE
	const EVENT_SHINY_ODDISH
	const EVENT_SHINY_LARVITAR
	const EVENT_SHINY_KRABBY
	const EVENT_SHINY_DITTO
	const EVENT_SHINY_MEWTWO
	const EVENT_SHINY_MEW
	const EVENT_SHINY_ARTICUNO
	const EVENT_SHINY_ZAPDOS
	const EVENT_SHINY_MOLTRES
	const EVENT_YELLOW_SAGE
	const EVENT_BLUE_SAGE
	const EVENT_RED_SAGE
	const EVENT_GRAND_SAGE
	const EVENT_BEAT_YELLOW_SAGE
	const EVENT_BEAT_BLUE_SAGE
	const EVENT_BEAT_RED_SAGE
	const EVENT_BEAT_GRAND_SAGE
	const EVENT_FOUGHT_ARTICUNO
	const EVENT_FOUGHT_ZAPDOS
	const EVENT_FOUGHT_MOLTRES
	const EVENT_HAS_SUICUNE
	const EVENT_HAS_RAIKOU
	const EVENT_HAS_ENTEI
	const EVENT_BLUE_SAGE_OUTSIDE
	const EVENT_YELLOW_SAGE_OUTSIDE
	const EVENT_RED_SAGE_OUTSIDE
	const EVENT_GRAND_SAGE_OUTSIDE
; Unused: next 34 events
