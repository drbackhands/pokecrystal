...
; wDailyFlags2::
	...
	const DAILYFLAGS2_BATTLED_BLUE_SAGE_F				  ; 8
	const DAILYFLAGS2_BATTLED_YELLOW_SAGE_F				  ; 9
	const DAILYFLAGS2_BATTLED_RED_SAGE_F				  ; a
	const DAILYFLAGS2_BATTLED_GRAND_SAGE_F				  ; b
